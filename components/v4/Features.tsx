...
import { RefreshCw, FileText, Globe, Key, Shield, ArrowRight } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16 max-w-3xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold font-sans text-slate-900 dark:text-white mb-6">
            Die Brücke zwischen <br/><span className="text-primary-600">Fintech und Buchhaltung</span>
          </h2>
          <p className="text-slate-600 dark:text-slate-400 text-lg">
            BelegBoost normalisiert Daten aus hunderten Quellen, konvertiert Fremdwährungen zum Tageskurs und lernt mit jeder Buchung dazu.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="md:col-span-2 bg-slate-50 dark:bg-slate-900 rounded-3xl p-8 border border-slate-200 dark:border-slate-800 overflow-hidden relative group">
                <div className="relative z-10">
                    ...
                    <p className="text-slate-600 dark:text-slate-400 max-w-md">
                        Wir rufen automatisch den offiziellen EZB-Referenzkurs für jeden Transaktionstag ab. USD, GBP, JPY werden korrekt in EUR umgerechnet und buchungsfertig aufbereitet.
                    </p>
                </div>
                
                {/* Visual Representation */}
                <div className="absolute right-0 bottom-8 translate-x-1/4 md:translate-x-0 md:right-8 bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700 p-4 w-64 opacity-90 group-hover:scale-105 transition-transform duration-300">
                    <div className="flex justify-between items-center text-xs mb-2 pb-2 border-b border-slate-100 dark:border-slate-700">
            ...
            <div className="md:col-span-1 md:row-span-2 bg-slate-900 dark:bg-white text-white dark:text-slate-900 rounded-3xl p-8 overflow-hidden relative group">
                <div className="relative z-10">
                    ...
                    <h3 className="text-2xl font-bold mb-3">DATEV XML & CSV</h3>
                    <p className="text-slate-300 dark:text-slate-600 mb-8">
                        Vollständig kompatibel mit DATEV Unternehmen online und Kanzlei-Rechnungswesen. Inklusive Belegbild-Verknüpfung.
                    </p>
                </div>
                {/* Abstract Visual */}
                ...
                <div className="absolute bottom-6 left-6 right-6 space-y-2 font-mono text-xs opacity-60">
                    <div className="bg-white/10 dark:bg-black/5 p-2 rounded border border-white/10 dark:border-black/10 truncate">
                        "Umsatz";"Soll";"Haben";"Datum"
                    </div>
                    <div className="bg-white/10 dark:bg-black/5 p-2 rounded border border-white/10 dark:border-black/10 truncate">
                        "129,00";"4930";"1200";"2402"
                    </div>
                    <div className="bg-white/10 dark:bg-black/5 p-2 rounded border border-white/10 dark:border-black/10 truncate">
                        "39,42";"4670";"1200";"2402"
                    </div>
                </div>
            </div>

            {/* Feature 3: Smart Mapping (Small) */}
            <div className="md:col-span-1 bg-white dark:bg-slate-900 rounded-3xl p-8 border border-slate-200 dark:border-slate-800 hover:border-primary-200 dark:hover:border-primary-800 transition-colors group">
                ...
                <p className="text-sm text-slate-600 dark:text-slate-400">
                    Verbinden Sie beliebig viele Wise, Revolut, N26 und Holvi Konten.
                </p>
            </div>
