import type { Submission, TeamMember, Provider, Advisor } from '../types';
...
export const SUBMISSIONS: Submission[] = [
  {
    ...
    clientNumber: '10492',
    clientEmail: 'buchhaltung@designstudio.de',
  ...
  },
  {
    ...
    clientNumber: '10550',
    clientEmail: 'finance@techstart.de',
    provider: 'Wise',
    providerLogo: 'WI',
  ...
  },
  {
    ...
    clientNumber: '10200',
    clientEmail: 'info@mueller-handwerk.de',
    provider: 'Sparkasse',
    providerLogo: 'SP',
  ...
  },
  {
    ...
    clientNumber: '10600',
    clientEmail: 'accounting@globaltrade.com',
    provider: 'Revolut',
    providerLogo: 'RE',
    dateFrom: new Date('2025-09-01'),
    dateTo: new Date('2025-09-30'),
  ...
  },
  {
    ...
    clientNumber: '10110',
    clientEmail: 'kontakt@coffeeandco.de',
    provider: 'PayPal',
    providerLogo: 'PP',
    dateFrom: new Date('2025-08-01'),
    dateTo: new Date('2025-08-31'),
    period: '01.08.2025 - 31.08.2025',
    receivedAt: new Date('2025-09-28'),
  ...
  },
  {
    ...
    clientNumber: '10880',
    clientEmail: 'office@schmidt-consulting.de',
    provider: 'ING',
    providerLogo: 'IN',
    dateFrom: new Date('2025-10-15'),
    dateTo: new Date('2025-11-05'),
