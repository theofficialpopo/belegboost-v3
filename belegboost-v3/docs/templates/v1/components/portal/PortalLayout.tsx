    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900 flex flex-col font-sans transition-colors duration-300">
      ...
      <footer className="py-6 text-center text-slate-400 dark:text-slate-600 text-xs">
        ...
        <div className="mt-2 flex justify-center gap-4">
          <button onClick={() => onNavigate?.('datenschutz')} className="hover:underline">Datenschutz</button>
          <button onClick={() => onNavigate?.('impressum')} className="hover:underline">Impressum</button>
        </div>
      </footer>
    </div>
  );
