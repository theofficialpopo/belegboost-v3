...
const Hero: React.FC<HeroProps> = ({ onNavigate }) => {
  return (
    <section className="relative pt-48 pb-20 lg:pt-56 lg:pb-32">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            
            {/* Left Content */}
            <div className="text-center lg:text-left">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/60 dark:bg-slate-900/40 border border-slate-200/60 dark:border-white/10 shadow-sm mb-8 backdrop-blur-md animate-in slide-in-from-bottom-4 fade-in duration-700 ring-1 ring-white/20">
                ...
                <p className="text-lg text-slate-600 dark:text-slate-300 mb-8 leading-relaxed max-w-2xl mx-auto lg:mx-0 animate-in slide-in-from-bottom-8 fade-in duration-700 delay-200">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 mb-12 animate-in slide-in-from-bottom-8 fade-in duration-700 delay-300">
                  <Button 
                    size="lg" 
                    className="rounded-full shadow-xl shadow-primary-500/20 px-8 hover:-translate-y-1 transition-transform"
                    onClick={() => onNavigate?.('signup')}
                  >
                    Kostenlos starten
                    <ArrowRight className="ml-2 w-5 h-5" />
                  </Button>
                  <Button variant="outline" size="lg" className="rounded-full bg-white/40 dark:bg-slate-900/40 backdrop-blur-md border-slate-200/50 dark:border-white/10 hover:bg-white/60 dark:hover:bg-slate-800/60">
                    Formate ansehen
                  </Button>
                </div>
