  ...
  const sections = [
    {
      ...
      links: [
        ...
        { label: "Preise", page: "landing", hash: "pricing" },
        { label: "Integration", page: "integration" },
        { label: "Sicherheit", page: "sicherheit" },
      ]
    },
    {
      title: "Ressourcen",
      links: [
        { label: "Dokumentation", page: "dokumentation" },
        { label: "Blog", page: "blog" },
        { label: "API Referenz", page: "api-referenz" },
        { label: "Demo Portal", page: "portal" },
      ]
    },
    {
      title: "Unternehmen",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                {section.links.map((link) => (
                  <li key={link.label}>
                    <button 
                      ...
                      className="text-slate-500 dark:text-slate-400 hover:text-primary-600 dark:hover:text-primary-400 text-sm font-medium transition-colors text-left"
                    >
                      {link.label}
                    </button>
                  </li>
        ...
        <div className="border-t border-slate-100 dark:border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-8">
            <button onClick={(e) => handleNav(e, 'datenschutz')} className="text-slate-500 dark:text-slate-400 hover:text-primary-600 dark:hover:text-primary-400 text-sm transition-colors">Datenschutz</button>
            <button onClick={(e) => handleNav(e, 'agb')} className="text-slate-500 dark:text-slate-400 hover:text-primary-600 dark:hover:text-primary-400 text-sm transition-colors">AGB</button>
            <button onClick={(e) => handleNav(e, 'impressum')} className="text-slate-500 dark:text-slate-400 hover:text-primary-600 dark:hover:text-primary-400 text-sm transition-colors">Impressum</button>
          </div>
        </div>
      </div>
    </footer>
